                ...
                var data = {
                    ...
                    commit = function(transactional) {
                        ...
                        return api_call({
                            ...
                            log.debug('transaction was committed ' + JSON.stringify(result));
                            active_transaction = null;
                ...
                var gqldata = {},
                    ...
                    execute = function() {
                        ...
                        return api_call({
                            ...
                            var query_time = process.hrtime(start);
                            ...
                            log.debug(result);
                            log.info('query:' + cust_id + ':' + query_time + ':' + gqldata.gqlQuery.queryString);
